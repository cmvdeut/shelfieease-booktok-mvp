    ...
    <main className="min-h-dvh bg-[#0b0b10] text-white">
      ...
      <div className="relative mx-auto max-w-md px-6 pt-8 pb-10">
        ...
        <header className="flex items-center gap-3">
          <div className="grid h-12 w-12 place-items-center rounded-2xl bg-white/10 ring-1 ring-white/15 shadow">
        ...
        <section className="mt-7">
          ...
          <p className="mt-2 text-base text-white/80">
            Scan een ISBN of typ ’m in. Klaar.
          </p>
          ...
          {/* Compact “why” chips (past meestal boven de fold) */}
          <div className="mt-6 grid gap-2">
            <div className="flex items-center justify-between rounded-2xl bg-white/5 ring-1 ring-white/10 px-4 py-3">
              <div>
            ...
            <div className="flex items-center justify-between rounded-2xl bg-white/5 ring-1 ring-white/10 px-4 py-3">
              <div>
                ...
                <div className="text-xs text-white/70">9:16 share-card</div>
              </div>
              <div className="grid h-9 w-9 place-items-center rounded-2xl bg-white/10 ring-1 ring-white/10">
                🪄
              </div>
          ...
          <footer className="mt-6 text-xs text-white/55">
            Tip: Handmatig invoeren blijft altijd.
          </footer>
        </section>
      </div>
    </main>
