    ...
    <main style={{ minHeight: "100dvh", background: "var(--bg)", color: "var(--text)" }} data-ui-lang={lang}>
      ...
      <div style={{ position: "relative", maxWidth: 448, margin: "0 auto", padding: "28px 24px 36px" }}>
        ...
        <header style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ display: "grid", height: 64, width: 64, placeItems: "center", borderRadius: 16, background: "var(--panel)", border: "1px solid var(--border)", boxShadow: "0 4px 12px var(--shadow)", overflow: "hidden" }}>
            <img 
